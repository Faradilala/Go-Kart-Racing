...
public class Controller2 : MonoBehaviour, IPointerUpHandler, IPointerDownHandler, IDragHandler
{
    ...
    IEnumerator PlayerMove() {
        ...
        while(true) {
            if(onMove) {
                GameManager2.instance.curSpeedText.text = string.Format("{0:000.00}", playerSpeed * 10);
